...
-- ldbanno -n VHDL -o lab48_impl1_vho.vho -w -neg -gui lab48_impl1.ncd 
-- Netlist created on Thu Dec 10 21:04:16 2020
-- Netlist written on Thu Dec 10 21:04:35 2020
...
-- entity count
  ...
  entity count is
    port (clk_25m: in Std_logic; btn_up: in Std_logic; 
  ...
  begin
    SLICE_0I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   ...
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0x00FF", 
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", CHECK_DI1=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>led_c_0, C1=>'X', D1=>VCC, DI1=>R_s_0, 
                DI0=>'X', A0=>'X', B0=>'X', C0=>'X', D0=>VCC, FCI=>'X', 
                M0=>'X', CE=>'X', CLK=>clk_key, LSR=>'X', FCO=>R_cry_0, 
                F1=>R_s_0, Q1=>led_c_0, F0=>open, Q0=>open);
    ...
    SLICE_18I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0xCCCC", 
                   INIT1_INITVAL=>"0x0000", REG0_SD=>"VHI", CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>'X', C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>R_s_7, A0=>'X', B0=>led_c_7, C0=>'X', D0=>'X', 
                FCI=>R_cry_6, M0=>'X', CE=>'X', CLK=>clk_key, LSR=>'X', 
                FCO=>open, F1=>open, Q1=>open, F0=>R_s_7, Q0=>led_c_7);
    SLICE_19I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
      ...
      port map (M1=>'X', A1=>'X', B1=>led_c_6, C1=>'X', D1=>VCC, DI1=>R_s_6, 
                DI0=>R_s_5, A0=>'X', B0=>led_c_5, C0=>'X', D0=>VCC, 
                FCI=>R_cry_4, M0=>'X', CE=>'X', CLK=>clk_key, LSR=>'X', 
                FCO=>R_cry_6, F1=>R_s_6, Q1=>led_c_6, F0=>R_s_5, Q0=>led_c_5);
    SLICE_20I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   ...
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>led_c_4, C1=>'X', D1=>VCC, DI1=>R_s_4, 
                DI0=>R_s_3, A0=>led_c_3, B0=>'X', C0=>'X', D0=>VCC, 
                FCI=>R_cry_2, M0=>'X', CE=>'X', CLK=>clk_key, LSR=>'X', 
                FCO=>R_cry_4, F1=>R_s_4, Q1=>led_c_4, F0=>R_s_3, Q0=>led_c_3);
    SLICE_21I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0xCC00", 
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>led_c_2, C1=>'X', D1=>VCC, DI1=>R_s_2, 
                DI0=>R_s_1, A0=>'X', B0=>led_c_1, C0=>'X', D0=>VCC, 
                FCI=>R_cry_0, M0=>'X', CE=>'X', CLK=>clk_key, LSR=>'X', 
                FCO=>R_cry_2, F1=>R_s_2, Q1=>led_c_2, F0=>R_s_1, Q0=>led_c_1);
    ...
    I_debouncer_SLICE_24I: SLOGICB
      generic map (LUT0_INITVAL=>X"F00F")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>'X', C0=>clk_key, 
                D0=>I_debouncer_R_key_sync, M0=>'X', CE=>'X', CLK=>'X', 
    ...
    I_debouncer_SLICE_25I: SLOGICB
      generic map (M0MUX=>"SIG", CLKMUX=>"SIG", CEMUX=>"SIG", GSR=>"DISABLED", 
                   SRMODE=>"ASYNC", LSRONMUX=>"OFF", LUT0_INITVAL=>X"2828", 
                   CHECK_M0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>I_debouncer_R_debounce_cnt_31, 
                B0=>clk_key, C0=>I_debouncer_R_key_sync, D0=>'X', 
