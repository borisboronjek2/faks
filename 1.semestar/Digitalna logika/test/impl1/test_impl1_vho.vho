...
-- ldbanno -n VHDL -o test_impl1_vho.vho -w -neg -gui test_impl1.ncd 
-- Netlist created on Wed Nov 04 18:45:00 2020
-- Netlist written on Wed Nov 04 18:45:13 2020
...
-- entity rs232_txB
  ...
  begin
    rs232_tx_pad: ec2iobuf
      port map (I=>IOLDO_ipd, T=>GNDI, PAD=>rs232tx_out);
    DRIVEGND: gndB
      port map (PWR0=>GNDI);
...
-- entity lab2
  ...
  architecture Structure of lab2 is
    ...
    signal I1_R_byte_old_2: Std_logic;
    ...
    signal I1_g0_0_0: Std_logic;
    signal I1_g0_0_6: Std_logic;
    signal I1_un14_r_debounce_cnt_30_10: Std_logic;
    signal I1_g0_0_5: Std_logic;
    signal I1_un1_R_debounce_cnt_1_3: Std_logic;
    signal I1_un14_r_debounce_cnt_30: Std_logic;
    signal I1_un1_R_debounce_cnt_3_31: Std_logic;
    signal I1_R_tx_phase_1: Std_logic;
    signal I1_R_tx_phase_0: Std_logic;
    signal I1_R_tx_phase_RNO_0_1: Std_logic;
    signal I1_R_tx_ser_0_sqmuxa: Std_logic;
    signal I1_g0_0_10_0: Std_logic;
    ...
    signal I1_g1_9: Std_logic;
    signal I1_g1_10: Std_logic;
    signal I1_N_5_i_0_0: Std_logic;
    signal I1_g2: Std_logic;
    signal I1_N_318_0: Std_logic;
    signal I1_g0_0_9_0: Std_logic;
    signal I1_g0_0_10: Std_logic;
    ...
    signal I1_un6_r_tx_tickcnt: Std_logic;
    signal I1_r_tx_tickcnt12: Std_logic;
    signal I1_R_tx_ser_3: Std_logic;
    signal I1_R_tx_ser_2: Std_logic;
    signal I1_R_tx_ser_5_2: Std_logic;
    signal I1_R_tx_ser_5_1: Std_logic;
    signal I1_R_tx_ser_1_sqmuxa_i: Std_logic;
    signal I1_R_tx_ser_1: Std_logic;
    signal I1_R_tx_ser_5: Std_logic;
    signal I1_R_tx_ser_4: Std_logic;
    signal I1_R_tx_ser_5_4: Std_logic;
    signal I1_R_tx_ser_5_3: Std_logic;
    signal I1_R_tx_ser_7: Std_logic;
    signal I1_R_tx_ser_6: Std_logic;
    signal I1_R_tx_ser_5_6: Std_logic;
    signal I1_R_tx_ser_5_5: Std_logic;
    signal I1_un6_r_tx_tickcnt_x: Std_logic;
    signal I1_R_tx_tickcnt_3: Std_logic;
    signal I1_g0_5_sx: Std_logic;
    signal I1_R_tx_ser_8: Std_logic;
    signal I1_R_tx_ser_5_7: Std_logic;
    signal I1_R_tx_tickcnt_0: Std_logic;
    signal I1_R_tx_tickcnt_1: Std_logic;
    signal I1_un1_R_tx_phase_1: Std_logic;
    signal I1_R_tx_tickcnte_0_1: Std_logic;
    signal I1_R_tx_tickcnt_e0: Std_logic;
    signal I1_R_tx_tickcnt_n3: Std_logic;
    signal I1_R_tx_tickcnt_2: Std_logic;
    signal I1_R_tx_tickcnt_n2: Std_logic;
    signal I1_R_tx_tickcnte_0_3: Std_logic;
    signal I1_R_tx_tickcnte_0_2: Std_logic;
    signal I1_R_tx_tickcnt_n1: Std_logic;
    signal I1_R_tx_tickcnt_fast_1: Std_logic;
    signal I1_R_tx_tickcnt_fast_0: Std_logic;
    signal I1_R_tx_tickcnte_0_fast_1: Std_logic;
    signal I1_R_tx_tickcnt_e0_fast: Std_logic;
    signal I1_R_tx_tickcnt_fast_2: Std_logic;
    signal I1_R_tx_tickcnte_0_fast_2: Std_logic;
    signal I1_R_tx_ser_5_0: Std_logic;
    signal I1_g1_11: Std_logic;
    signal I1_g0_0_sn: Std_logic;
    signal I1_un14_r_debounce_cnt_30_9: Std_logic;
    signal I1_R_debounce_cnt_RNICPRA1_17: Std_logic;
    signal I1_R_debounce_cnt_RNIJVQA1_0_1: Std_logic;
    signal I1_R_debounce_cnt_RNIS4PV4_2: Std_logic;
    signal I1_g0_0_mb_1: Std_logic;
    signal I1_R_tx_phase_0_sqmuxa_2: Std_logic;
    signal I1_g0_3_5: Std_logic;
    signal I1_g0_1: Std_logic;
    signal I1_g1_0_0: Std_logic;
    signal I1_g0_0_7_1: Std_logic;
    signal I1_g0_0_6_1: Std_logic;
    signal I1_g0_0_8_0: Std_logic;
    signal I1_g0_0_5_0: Std_logic;
    signal I1_g0_0_4: Std_logic;
    signal I1_g0_11: Std_logic;
    signal I1_un14_r_debounce_cnt_26_4: Std_logic;
    signal I1_g0_3_4: Std_logic;
    signal I1_g0_3_2: Std_logic;
    signal I1_un14_r_debounce_cnt_26_5: Std_logic;
    signal I1_un14_r_debounce_cnt_30_11: Std_logic;
    signal I1_g0_3_6: Std_logic;
    signal I1_g0_1_6_1: Std_logic;
    signal I1_g0_2_3: Std_logic;
    signal I1_g0_1_4: Std_logic;
    signal I1_g0_7: Std_logic;
    signal I1_g0_1_6: Std_logic;
    signal I1_R_tx_phase_RNO_3_1: Std_logic;
    signal I1_g0_0_14_0: Std_logic;
    signal I1_R_tx_phase_RNO_2_1: Std_logic;
    signal I1_g0_0_6_2: Std_logic;
    signal I1_R_tx_phase_RNO_7_0: Std_logic;
    signal I1_g0_0_1_1: Std_logic;
    signal I1_g0_0_7_2: Std_logic;
    signal I1_g0_0_6_0: Std_logic;
    signal I1_g0_0_9_0_0: Std_logic;
    signal I1_g0_0_8_1: Std_logic;
    signal I1_g0_0_9_1: Std_logic;
    signal I1_g1_0_2: Std_logic;
    signal I1_g1_4: Std_logic;
    signal I1_g1_5_0: Std_logic;
    signal I1_R_debounce_cnt_RNIQLJM1_0_12: Std_logic;
    signal I1_g1_9_0: Std_logic;
    signal I1_m15_0_a3_12: Std_logic;
    signal I1_g1_10_0: Std_logic;
    signal I1_R_tx_phase_RNO_8_1: Std_logic;
  ...
  begin
    I1_SLICE_0I: SCCU2B
      ...
      port map (M1=>'X', A1=>I1_R_debounce_cnt_0, B1=>'X', C1=>'X', D1=>I1_VCC, 
    ...
    I1_SLICE_1I: SCCU2B
      ...
      port map (M1=>'X', A1=>'X', B1=>'X', C1=>'X', D1=>I1_VCC, DI1=>'X', 
                DI0=>'X', A0=>N_11, B0=>I1_R_byte_old_6, C0=>'X', D0=>'X', 
                FCI=>I1_un1_byte_in_0_data_tmp_2, M0=>'X', CE=>'X', CLK=>'X', 
                LSR=>'X', FCO=>open, F1=>I1_un1_byte_in_i, Q1=>open, F0=>open, 
                Q0=>open);
    I1_SLICE_2I: SCCU2B
      generic map (INIT0_INITVAL=>"0x9009", INIT1_INITVAL=>"0x9009")
      port map (M1=>'X', A1=>N_12, B1=>I1_R_byte_old_5, C1=>N_8, 
                D1=>I1_R_byte_old_4, DI1=>'X', DI0=>'X', A0=>N_41, 
                B0=>I1_R_byte_old_3, C0=>N_42, D0=>I1_R_byte_old_2, 
    ...
    I1_SLICE_3I: SCCU2B
      ...
      port map (M1=>'X', A1=>N_45, B1=>I1_R_byte_old_0, C1=>N_43, 
                D1=>I1_R_byte_old_1, DI1=>'X', DI0=>'X', A0=>'X', B0=>'X', 
    ...
    I1_SLICE_12I: SCCU2B
      ...
      port map (M1=>'X', A1=>'X', B1=>I1_R_baudgen_0, C1=>'X', D1=>I1_VCC, 
                DI1=>'X', DI0=>'X', A0=>'X', B0=>'X', C0=>'X', D0=>'X', 
                FCI=>'X', M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
    ...
    I1_SLICE_18I: SCCU2B
      ...
      port map (M1=>'X', A1=>'X', B1=>I1_R_debounce_cnt_22, C1=>'X', 
                ...
                DI0=>I1_un1_R_debounce_cnt_3_s1_10, A0=>'X', 
                B0=>I1_R_debounce_cnt_21, C0=>'X', D0=>I1_VCC, 
    ...
    I1_SLICE_23I: SCCU2B
      ...
      port map (M1=>'X', A1=>'X', B1=>I1_R_debounce_cnt_12, C1=>'X', 
                ...
                DI0=>I1_un1_R_debounce_cnt_3_s1_20, A0=>'X', 
                B0=>I1_R_debounce_cnt_11, C0=>'X', D0=>I1_VCC, 
                ...
                F0=>I1_un1_R_debounce_cnt_3_s1_20, Q0=>I1_R_debounce_cnt_11);
    I1_SLICE_24I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   CCU2_INJECT1_0=>"NO", CCU2_INJECT1_1=>"NO", 
                   REG0_REGSET=>"SET", GSR=>"DISABLED", 
      ...
      port map (M1=>'X', A1=>'X', B1=>I1_R_debounce_cnt_10, C1=>'X', 
                ...
                F1=>I1_un1_R_debounce_cnt_3_s1_21, Q1=>I1_R_debounce_cnt_10, 
    ...
    I1_SLICE_25I: SCCU2B
      ...
      port map (M1=>'X', A1=>'X', B1=>I1_R_debounce_cnt_8, C1=>'X', D1=>I1_VCC, 
                DI1=>I1_un1_R_debounce_cnt_3_s1_23, 
                DI0=>I1_un1_R_debounce_cnt_3_s1_24, A0=>'X', 
                ...
                F0=>I1_un1_R_debounce_cnt_3_s1_24, Q0=>I1_R_debounce_cnt_7);
    I1_SLICE_26I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   CCU2_INJECT1_0=>"NO", CCU2_INJECT1_1=>"NO", 
                   REG1_REGSET=>"SET", GSR=>"DISABLED", 
      ...
      port map (M1=>'X', A1=>'X', B1=>I1_R_debounce_cnt_6, C1=>'X', D1=>I1_VCC, 
                DI1=>I1_un1_R_debounce_cnt_3_s1_25, 
                DI0=>I1_un1_R_debounce_cnt_3_s1_26, A0=>'X', 
                B0=>I1_R_debounce_cnt_5, C0=>'X', D0=>I1_VCC, 
                FCI=>I1_un1_R_debounce_cnt_3_cry_4_s1, M0=>'X', 
                CE=>I1_un1_R_debounce_cnt_1_i, CLK=>clk_25m_c, 
                LSR=>I1_un1_byte_in_i, FCO=>I1_un1_R_debounce_cnt_3_cry_6_s1, 
                F1=>I1_un1_R_debounce_cnt_3_s1_25, Q1=>I1_R_debounce_cnt_6, 
    ...
    I1_SLICE_27I: SCCU2B
      ...
      port map (M1=>'X', A1=>'X', B1=>I1_R_debounce_cnt_4, C1=>'X', D1=>I1_VCC, 
                DI1=>I1_un1_R_debounce_cnt_3_s1_27, 
                DI0=>I1_un1_R_debounce_cnt_3_s1_28, A0=>I1_R_debounce_cnt_3, 
                B0=>'X', C0=>'X', D0=>I1_VCC, 
                FCI=>I1_un1_R_debounce_cnt_3_cry_2_s1, M0=>'X', 
                CE=>I1_un1_R_debounce_cnt_1_i, CLK=>clk_25m_c, 
                LSR=>I1_un1_byte_in_i, FCO=>I1_un1_R_debounce_cnt_3_cry_4_s1, 
                F1=>I1_un1_R_debounce_cnt_3_s1_27, Q1=>I1_R_debounce_cnt_4, 
    ...
    SLICE_30I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", GSR=>"DISABLED", 
                   ...
                   LUT1_INITVAL=>X"F3F0", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>btn_down_c, 
                C1=>btn_right_c, D1=>btn_left_c, DI1=>N_43, DI0=>N_45, 
                A0=>btn_center_c, B0=>N_46, C0=>btn_right_c, D0=>btn_left_c, 
                M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', OFX1=>open, 
                F1=>N_43, Q1=>I1_R_byte_old_1, OFX0=>open, F0=>N_45, 
                Q0=>I1_R_byte_old_0);
    SLICE_31I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", GSR=>"DISABLED", 
                   SRMODE=>"ASYNC", LSRONMUX=>"OFF", LUT0_INITVAL=>X"FFB8", 
                   LUT1_INITVAL=>X"F3F0", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>btn_down_c, 
                C1=>btn_center_c, D1=>btn_up_c, DI1=>N_41, DI0=>N_42, 
                A0=>btn_center_c, B0=>btn_down_c, C0=>N_47, D0=>btn_up_c, 
                M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', OFX1=>open, 
                F1=>N_41, Q1=>I1_R_byte_old_3, OFX0=>open, F0=>N_42, 
                Q0=>I1_R_byte_old_2);
    SLICE_32I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", GSR=>"DISABLED", 
                   ...
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>btn_right_c, B1=>btn_center_c, 
                C1=>N_32, D1=>N_35, DI1=>N_12, DI0=>N_8, A0=>btn_right_c, 
                B0=>btn_down_c, C0=>'X', D0=>btn_up_c, M0=>'X', CE=>'X', 
                CLK=>clk_25m_c, LSR=>'X', OFX1=>open, F1=>N_12, 
                Q1=>I1_R_byte_old_5, OFX0=>open, F0=>N_8, Q0=>I1_R_byte_old_4);
    SLICE_33I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", GSR=>"DISABLED", 
                   SRMODE=>"ASYNC", LSRONMUX=>"OFF", LUT0_INITVAL=>X"FFFE", 
                   REG0_SD=>"VHI", CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>N_11, A0=>btn_left_c, B0=>btn_right_c, 
                C0=>btn_up_c, D0=>btn_center_c, M0=>'X', CE=>'X', 
                CLK=>clk_25m_c, LSR=>'X', OFX1=>open, F1=>open, Q1=>open, 
                OFX0=>open, F0=>N_11, Q0=>I1_R_byte_old_6);
    I1_SLICE_35I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", LSRMUX=>"SIG", GSR=>"DISABLED", 
                   LUT0_INITVAL=>X"9955", LUT1_INITVAL=>X"8000", 
                   REG0_SD=>"VHI", CHECK_DI0=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_g0_0_5, 
                B1=>I1_un14_r_debounce_cnt_30_10, C1=>I1_g0_0_6, D1=>I1_g0_0_0, 
                DI1=>'X', DI0=>I1_un1_R_debounce_cnt_3_31, 
                A0=>I1_R_debounce_cnt_0, B0=>I1_un14_r_debounce_cnt_30, 
                C0=>'X', D0=>I1_un1_R_debounce_cnt_1_3, M0=>'X', CE=>'X', 
                CLK=>clk_25m_c, LSR=>I1_un1_byte_in_i, OFX1=>open, 
                F1=>I1_un14_r_debounce_cnt_30, Q1=>open, OFX0=>open, 
                F0=>I1_un1_R_debounce_cnt_3_31, Q0=>I1_R_debounce_cnt_0);
    I1_SLICE_36I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", LSRMUX=>"SIG", GSR=>"DISABLED", 
                   LUT0_INITVAL=>X"3E3C", LUT1_INITVAL=>X"1BA0", 
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_tx_ser_0_sqmuxa, 
                B1=>I1_R_tx_phase_RNO_0_1, C1=>I1_R_tx_phase_0, 
                D1=>I1_R_tx_phase_1, DI1=>I1_R_tx_phase_7_1, 
                DI0=>I1_R_tx_phase_7_0, A0=>I1_g0_0_11, 
                B0=>I1_R_tx_ser_0_sqmuxa, C0=>I1_R_tx_phase_0, 
                D0=>I1_g0_0_10_0, M0=>'X', CE=>'X', CLK=>clk_25m_c, 
    ...
    I1_SLICE_37I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", LSRMUX=>"SIG", GSR=>"DISABLED", 
                   LUT0_INITVAL=>X"BF00", LUT1_INITVAL=>X"CCC4", 
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_g2, B1=>I1_N_5_i_0_0, 
                C1=>I1_g1_10, D1=>I1_g1_9, DI1=>I1_R_tx_phase_7_3, 
                DI0=>I1_R_tx_phase_7_2, A0=>I1_R_tx_ser_0_sqmuxa, 
                B0=>I1_g0_0_10, C0=>I1_g0_0_9_0, D0=>I1_N_318_0, M0=>'X', 
                CE=>'X', CLK=>clk_25m_c, LSR=>I1_R_tx_phase_0_sqmuxa, 
    ...
    I1_SLICE_38I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_tx_ser_3, 
                B1=>I1_r_tx_tickcnt12, C1=>I1_un6_r_tx_tickcnt, 
                D1=>I1_R_byte_old_1, DI1=>I1_R_tx_ser_5_2, 
                DI0=>I1_R_tx_ser_5_1, A0=>I1_R_byte_old_0, 
                B0=>I1_r_tx_tickcnt12, C0=>I1_un6_r_tx_tickcnt, 
                D0=>I1_R_tx_ser_2, M0=>'X', CE=>I1_R_tx_ser_1_sqmuxa_i, 
                CLK=>clk_25m_c, LSR=>'X', OFX1=>open, F1=>I1_R_tx_ser_5_2, 
                Q1=>I1_R_tx_ser_2, OFX0=>open, F0=>I1_R_tx_ser_5_1, 
                Q0=>I1_R_tx_ser_1);
    I1_SLICE_39I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", REG0_REGSET=>"SET", 
                   ...
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_r_tx_tickcnt12, 
                B1=>I1_R_tx_ser_5, C1=>I1_R_byte_old_3, 
                D1=>I1_un6_r_tx_tickcnt, DI1=>I1_R_tx_ser_5_4, 
                DI0=>I1_R_tx_ser_5_3, A0=>I1_r_tx_tickcnt12, 
                B0=>I1_R_byte_old_2, C0=>I1_R_tx_ser_4, 
                D0=>I1_un6_r_tx_tickcnt, M0=>'X', CE=>I1_R_tx_ser_1_sqmuxa_i, 
                CLK=>clk_25m_c, LSR=>'X', OFX1=>open, F1=>I1_R_tx_ser_5_4, 
                Q1=>I1_R_tx_ser_4, OFX0=>open, F0=>I1_R_tx_ser_5_3, 
                Q0=>I1_R_tx_ser_3);
    I1_SLICE_40I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", REG0_REGSET=>"SET", 
                   REG1_REGSET=>"SET", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", LUT0_INITVAL=>X"D8F0", 
                   LUT1_INITVAL=>X"E4CC", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_r_tx_tickcnt12, 
                B1=>I1_R_byte_old_5, C1=>I1_R_tx_ser_7, 
                D1=>I1_un6_r_tx_tickcnt, DI1=>I1_R_tx_ser_5_6, 
                DI0=>I1_R_tx_ser_5_5, A0=>I1_r_tx_tickcnt12, B0=>I1_R_tx_ser_6, 
                C0=>I1_R_byte_old_4, D0=>I1_un6_r_tx_tickcnt, M0=>'X', 
                CE=>I1_R_tx_ser_1_sqmuxa_i, CLK=>clk_25m_c, LSR=>'X', 
                OFX1=>open, F1=>I1_R_tx_ser_5_6, Q1=>I1_R_tx_ser_6, OFX0=>open, 
                F0=>I1_R_tx_ser_5_5, Q0=>I1_R_tx_ser_5);
    I1_SLICE_41I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", REG0_REGSET=>"SET", 
                   REG1_REGSET=>"SET", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", LUT0_INITVAL=>X"F870", 
                   LUT1_INITVAL=>X"4000", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_g0_5_sx, 
                B1=>I1_R_tx_tickcnt_3, C1=>I1_un6_r_tx_tickcnt_x, 
                D1=>I1_R_baudgen_16, DI1=>I1_R_tx_ser_0_sqmuxa, 
                DI0=>I1_R_tx_ser_5_7, A0=>I1_un6_r_tx_tickcnt, 
                B0=>I1_r_tx_tickcnt12, C0=>I1_R_byte_old_6, D0=>I1_R_tx_ser_8, 
                M0=>'X', CE=>I1_R_tx_ser_1_sqmuxa_i, CLK=>clk_25m_c, LSR=>'X', 
                OFX1=>open, F1=>I1_R_tx_ser_0_sqmuxa, Q1=>I1_R_tx_ser_8, 
                OFX0=>open, F0=>I1_R_tx_ser_5_7, Q0=>I1_R_tx_ser_7);
    I1_SLICE_42I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", GSR=>"DISABLED", 
                   SRMODE=>"ASYNC", LSRONMUX=>"OFF", LUT0_INITVAL=>X"BB44", 
                   LUT1_INITVAL=>X"9CCC", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_un1_R_tx_phase_1, 
                B1=>I1_R_tx_tickcnt_1, C1=>I1_R_tx_tickcnt_0, 
                D1=>I1_R_baudgen_16, DI1=>I1_R_tx_tickcnte_0_1, 
                DI0=>I1_R_tx_tickcnt_e0, A0=>I1_un1_R_tx_phase_1, 
                B0=>I1_R_baudgen_16, C0=>'X', D0=>I1_R_tx_tickcnt_0, M0=>'X', 
                CE=>'X', CLK=>clk_25m_c, LSR=>'X', OFX1=>open, 
                F1=>I1_R_tx_tickcnte_0_1, Q1=>I1_R_tx_tickcnt_1, OFX0=>open, 
                F0=>I1_R_tx_tickcnt_e0, Q0=>I1_R_tx_tickcnt_0);
    I1_SLICE_43I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", GSR=>"DISABLED", 
                   SRMODE=>"ASYNC", LSRONMUX=>"OFF", LUT0_INITVAL=>X"FD08", 
                   LUT1_INITVAL=>X"B8AA", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_tx_tickcnt_3, 
                B1=>I1_un1_R_tx_phase_1, C1=>I1_R_tx_tickcnt_n3, 
                D1=>I1_R_baudgen_16, DI1=>I1_R_tx_tickcnte_0_3, 
                DI0=>I1_R_tx_tickcnte_0_2, A0=>I1_R_baudgen_16, 
                B0=>I1_R_tx_tickcnt_n2, C0=>I1_un1_R_tx_phase_1, 
                D0=>I1_R_tx_tickcnt_2, M0=>'X', CE=>'X', CLK=>clk_25m_c, 
                LSR=>'X', OFX1=>open, F1=>I1_R_tx_tickcnte_0_3, 
                Q1=>I1_R_tx_tickcnt_3, OFX0=>open, F0=>I1_R_tx_tickcnte_0_2, 
                Q0=>I1_R_tx_tickcnt_2);
    I1_SLICE_44I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", GSR=>"DISABLED", 
                   SRMODE=>"ASYNC", LSRONMUX=>"OFF", LUT0_INITVAL=>X"CF30", 
                   LUT1_INITVAL=>X"CCE4", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_baudgen_16, 
                B1=>I1_R_tx_tickcnt_fast_1, C1=>I1_R_tx_tickcnt_n1, 
                D1=>I1_un1_R_tx_phase_1, DI1=>I1_R_tx_tickcnte_0_fast_1, 
                DI0=>I1_R_tx_tickcnt_e0_fast, A0=>'X', B0=>I1_un1_R_tx_phase_1, 
                C0=>I1_R_baudgen_16, D0=>I1_R_tx_tickcnt_fast_0, M0=>'X', 
                CE=>'X', CLK=>clk_25m_c, LSR=>'X', OFX1=>open, 
                F1=>I1_R_tx_tickcnte_0_fast_1, Q1=>I1_R_tx_tickcnt_fast_1, 
                OFX0=>open, F0=>I1_R_tx_tickcnt_e0_fast, 
                Q0=>I1_R_tx_tickcnt_fast_0);
    I1_SLICE_45I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", GSR=>"DISABLED", 
                   SRMODE=>"ASYNC", LSRONMUX=>"OFF", LUT0_INITVAL=>X"FD08", 
                   LUT1_INITVAL=>X"6C6C", REG0_SD=>"VHI", CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_tx_tickcnt_1, 
                B1=>I1_R_tx_tickcnt_2, C1=>I1_R_tx_tickcnt_0, D1=>'X', 
                DI1=>'X', DI0=>I1_R_tx_tickcnte_0_fast_2, A0=>I1_R_baudgen_16, 
                B0=>I1_R_tx_tickcnt_n2, C0=>I1_un1_R_tx_phase_1, 
                D0=>I1_R_tx_tickcnt_fast_2, M0=>'X', CE=>'X', CLK=>clk_25m_c, 
                LSR=>'X', OFX1=>open, F1=>I1_R_tx_tickcnt_n2, Q1=>open, 
                OFX0=>open, F0=>I1_R_tx_tickcnte_0_fast_2, 
                Q0=>I1_R_tx_tickcnt_fast_2);
    I1_SLICE_46I: SLOGICB
      generic map (LUT0_INITVAL=>X"2000", LUT1_INITVAL=>X"0001")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_tx_phase_3, 
                B1=>I1_R_tx_phase_1, C1=>I1_R_tx_phase_2, D1=>I1_R_tx_phase_0, 
                DI1=>'X', DI0=>'X', A0=>I1_R_baudgen_16, 
                B0=>I1_un1_R_tx_phase_1, C0=>I1_R_tx_ser_1, 
                D0=>I1_un6_r_tx_tickcnt, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>I1_un1_R_tx_phase_1, Q1=>open, OFX0=>open, 
                F0=>I1_R_tx_ser_5_0, Q0=>open);
    I1_SLICE_47I: SLOGICB
      generic map (LUT0_INITVAL=>X"8000", LUT1_INITVAL=>X"DF00")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_baudgen_16, 
                B1=>I1_un1_R_tx_phase_1, C1=>I1_un6_r_tx_tickcnt, D1=>I1_g1_11, 
                DI1=>'X', DI0=>'X', A0=>I1_R_tx_tickcnt_fast_1, 
                B0=>I1_R_tx_tickcnt_3, C0=>I1_R_tx_tickcnt_fast_0, 
                D0=>I1_R_tx_tickcnt_fast_2, M0=>'X', CE=>'X', CLK=>'X', 
                LSR=>'X', OFX1=>open, F1=>I1_g0_0_sn, Q1=>open, OFX0=>open, 
                F0=>I1_un6_r_tx_tickcnt, Q0=>open);
    I1_SLICE_48I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"BFFF")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_RNIS4PV4_2, 
                B1=>I1_R_debounce_cnt_RNIJVQA1_0_1, 
                C1=>I1_R_debounce_cnt_RNICPRA1_17, 
                D1=>I1_un14_r_debounce_cnt_30_9, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_28, B0=>I1_R_debounce_cnt_30, 
                C0=>I1_R_debounce_cnt_27, D0=>I1_R_debounce_cnt_29, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_g0_0_mb_1, 
                Q1=>open, OFX0=>open, F0=>I1_un14_r_debounce_cnt_30_9, 
                Q0=>open);
    I1_SLICE_49I: SLOGICB
      generic map (LUT0_INITVAL=>X"0040", LUT1_INITVAL=>X"8800")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_baudgen_16, 
                B1=>I1_un6_r_tx_tickcnt, C1=>'X', D1=>I1_R_tx_phase_0_sqmuxa_2, 
                DI1=>'X', DI0=>'X', A0=>I1_R_tx_phase_0, B0=>I1_R_tx_phase_3, 
                C0=>I1_R_tx_phase_1, D0=>I1_R_tx_phase_2, M0=>'X', CE=>'X', 
                CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_R_tx_phase_0_sqmuxa, 
                Q1=>open, OFX0=>open, F0=>I1_R_tx_phase_0_sqmuxa_2, Q0=>open);
    I1_SLICE_50I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"7FFF")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_un14_r_debounce_cnt_30_10, 
                B1=>I1_g0_3_5, C1=>I1_g0_0_0, D1=>I1_g0_0_5, DI1=>'X', 
                DI0=>'X', A0=>I1_R_debounce_cnt_16, B0=>I1_R_debounce_cnt_18, 
                C0=>I1_R_debounce_cnt_17, D0=>I1_R_debounce_cnt_19, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_g0_1, Q1=>open, 
                OFX0=>open, F0=>I1_un14_r_debounce_cnt_30_10, Q0=>open);
    I1_SLICE_51I: SLOGICB
      generic map (LUT0_INITVAL=>X"78F0", LUT1_INITVAL=>X"A0A0")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_tx_phase_1, B1=>'X', 
                C1=>I1_R_tx_phase_0, D1=>'X', DI1=>'X', DI0=>'X', 
                A0=>I1_R_baudgen_16, B0=>I1_g1_0_0, C0=>I1_R_tx_phase_2, 
                D0=>I1_un6_r_tx_tickcnt, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>I1_g1_0_0, Q1=>open, OFX0=>open, 
                F0=>I1_N_318_0, Q0=>open);
    I1_SLICE_52I: SLOGICB
      generic map (LUT0_INITVAL=>X"C000", LUT1_INITVAL=>X"C000")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>I1_g0_0_8_0, 
                C1=>I1_g0_0_6_1, D1=>I1_g0_0_7_1, DI1=>'X', DI0=>'X', A0=>'X', 
                B0=>I1_g0_11, C0=>I1_g0_0_4, D0=>I1_g0_0_5_0, M0=>'X', CE=>'X', 
                CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_g0_11, Q1=>open, 
                OFX0=>open, F0=>I1_g0_0_10, Q0=>open);
    I1_SLICE_53I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"0300")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>I1_R_debounce_cnt_2, 
                C1=>I1_R_debounce_cnt_3, D1=>I1_un14_r_debounce_cnt_26_4, 
                DI1=>'X', DI0=>'X', A0=>I1_R_debounce_cnt_10, 
                B0=>I1_R_debounce_cnt_8, C0=>I1_R_debounce_cnt_9, 
                D0=>I1_R_debounce_cnt_11, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>I1_g0_3_4, Q1=>open, OFX0=>open, 
                F0=>I1_un14_r_debounce_cnt_26_4, Q0=>open);
    I1_SLICE_54I: SLOGICB
      generic map (LUT0_INITVAL=>X"8000", LUT1_INITVAL=>X"FFFE")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_byte_old_1, 
                B1=>I1_R_byte_old_0, C1=>I1_g0_3_2, D1=>I1_R_byte_old_3, 
                DI1=>'X', DI0=>'X', A0=>I1_un14_r_debounce_cnt_30_9, 
                B0=>I1_un14_r_debounce_cnt_30_11, 
                C0=>I1_un14_r_debounce_cnt_26_5, D0=>I1_g2, M0=>'X', CE=>'X', 
                CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_g2, Q1=>open, 
                OFX0=>open, F0=>I1_g0_0_9_0, Q0=>open);
    I1_SLICE_55I: SLOGICB
      generic map (LUT0_INITVAL=>X"8800", LUT1_INITVAL=>X"0202")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_un14_r_debounce_cnt_26_5, 
                B1=>I1_R_debounce_cnt_4, C1=>I1_R_debounce_cnt_5, D1=>'X', 
                DI1=>'X', DI0=>'X', A0=>I1_g0_3_4, B0=>I1_g0_3_6, C0=>'X', 
                D0=>I1_g0_3_5, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>I1_g0_3_6, Q1=>open, OFX0=>open, 
                F0=>I1_un1_R_debounce_cnt_1_3, Q0=>open);
    I1_SLICE_56I: SLOGICB
      generic map (LUT0_INITVAL=>X"0500", LUT1_INITVAL=>X"DFFF")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_g0_3_6, B1=>I1_g0_1, 
                C1=>I1_g0_0_6, D1=>I1_g0_3_4, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_26, B0=>'X', C0=>I1_R_debounce_cnt_31, 
                D0=>I1_un14_r_debounce_cnt_30_9, M0=>'X', CE=>'X', CLK=>'X', 
                LSR=>'X', OFX1=>open, F1=>I1_un1_R_debounce_cnt_1_i, Q1=>open, 
                OFX0=>open, F0=>I1_g0_0_6, Q0=>open);
    I1_SLICE_57I: SLOGICB
      generic map (LUT0_INITVAL=>X"8000", LUT1_INITVAL=>X"0020")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_g0_2_3, 
                B1=>I1_R_debounce_cnt_4, C1=>I1_g0_1_6_1, 
                D1=>I1_R_debounce_cnt_11, DI1=>'X', DI0=>'X', 
                A0=>I1_un14_r_debounce_cnt_30_9, B0=>I1_g0_1_6, C0=>I1_g0_7, 
                D0=>I1_g0_1_4, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>I1_g0_1_6, Q1=>open, OFX0=>open, 
                F0=>I1_g0_0_10_0, Q0=>open);
    I1_SLICE_58I: SLOGICB
      generic map (LUT0_INITVAL=>X"8000", LUT1_INITVAL=>X"0040")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_tx_phase_RNO_2_1, 
                B1=>I1_g0_0_14_0, C1=>I1_g2, D1=>I1_R_tx_phase_RNO_3_1, 
                DI1=>'X', DI0=>'X', A0=>I1_un14_r_debounce_cnt_30_9, 
                B0=>I1_g0_0_6_2, C0=>I1_g0_7, D0=>I1_un14_r_debounce_cnt_26_5, 
                M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, 
                F1=>I1_R_tx_phase_RNO_0_1, Q1=>open, OFX0=>open, 
                F0=>I1_g0_0_14_0, Q0=>open);
    I1_SLICE_59I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"0888")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_g0_0_6_0, B1=>I1_g0_0_7_2, 
                C1=>I1_g0_0_1_1, D1=>I1_R_tx_phase_RNO_7_0, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_22, B0=>I1_R_debounce_cnt_20, 
                C0=>I1_R_debounce_cnt_23, D0=>I1_R_debounce_cnt_21, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_g0_0_11, 
                Q1=>open, OFX0=>open, F0=>I1_g0_0_6_0, Q0=>open);
    I1_SLICE_60I: SLOGICB
      generic map (LUT0_INITVAL=>X"1100", LUT1_INITVAL=>X"0001")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_13, 
                B1=>I1_R_debounce_cnt_15, C1=>I1_R_debounce_cnt_14, 
                D1=>I1_R_debounce_cnt_12, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_6, B0=>I1_R_debounce_cnt_7, C0=>'X', 
                D0=>I1_un14_r_debounce_cnt_26_5, M0=>'X', CE=>'X', CLK=>'X', 
                LSR=>'X', OFX1=>open, F1=>I1_un14_r_debounce_cnt_26_5, 
                Q1=>open, OFX0=>open, F0=>I1_g0_1_4, Q0=>open);
    I1_SLICE_61I: SLOGICB
      generic map (LUT0_INITVAL=>X"0100", LUT1_INITVAL=>X"3FFF")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>I1_g0_0_9_1, 
                C1=>I1_g0_0_8_1, D1=>I1_g0_0_9_0_0, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_6, B0=>I1_R_debounce_cnt_5, 
                C0=>I1_R_debounce_cnt_4, D0=>I1_R_debounce_cnt_0, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, 
                F1=>I1_R_tx_phase_RNO_2_1, Q1=>open, OFX0=>open, 
                F0=>I1_g0_0_9_1, Q0=>open);
    I1_SLICE_62I: SLOGICB
      generic map (LUT0_INITVAL=>X"8000", LUT1_INITVAL=>X"3CCC")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>I1_R_tx_phase_3, 
                C1=>I1_un6_r_tx_tickcnt, D1=>I1_g1_0_2, DI1=>'X', DI0=>'X', 
                A0=>I1_R_tx_phase_2, B0=>I1_R_baudgen_16, C0=>I1_R_tx_phase_0, 
                D0=>I1_R_tx_phase_1, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>I1_N_5_i_0_0, Q1=>open, OFX0=>open, 
                F0=>I1_g1_0_2, Q0=>open);
    I1_SLICE_63I: SLOGICB
      generic map (LUT0_INITVAL=>X"F7FF", LUT1_INITVAL=>X"0001")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_22, 
                B1=>I1_R_debounce_cnt_20, C1=>I1_R_debounce_cnt_23, 
                D1=>I1_R_debounce_cnt_21, DI1=>'X', DI0=>'X', 
                A0=>I1_un14_r_debounce_cnt_26_5, 
                B0=>I1_un14_r_debounce_cnt_30_9, C0=>I1_g1_4, 
                D0=>I1_un14_r_debounce_cnt_30_11, M0=>'X', CE=>'X', CLK=>'X', 
                LSR=>'X', OFX1=>open, F1=>I1_un14_r_debounce_cnt_30_11, 
                Q1=>open, OFX0=>open, F0=>I1_g1_9, Q0=>open);
    I1_SLICE_64I: SLOGICB
      generic map (LUT0_INITVAL=>X"FDFD", LUT1_INITVAL=>X"FFFE")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_10, 
                B1=>I1_R_debounce_cnt_4, C1=>I1_R_debounce_cnt_5, 
                D1=>I1_R_debounce_cnt_11, DI1=>'X', DI0=>'X', A0=>I1_g0_11, 
                B0=>I1_g1_5_0, C0=>I1_R_tx_ser_0_sqmuxa, D0=>'X', M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_g1_5_0, 
                Q1=>open, OFX0=>open, F0=>I1_g1_10, Q0=>open);
    I1_SLICE_65I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"7FFF")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_g1_10_0, 
                B1=>I1_m15_0_a3_12, C1=>I1_g1_9_0, 
                D1=>I1_R_debounce_cnt_RNIQLJM1_0_12, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_7, B0=>I1_R_debounce_cnt_10, 
                C0=>I1_R_debounce_cnt_9, D0=>I1_R_debounce_cnt_6, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, 
                F1=>I1_R_debounce_cnt_RNIS4PV4_2, Q1=>open, OFX0=>open, 
                F0=>I1_m15_0_a3_12, Q0=>open);
    I1_SLICE_66I: SLOGICB
      generic map (LUT0_INITVAL=>X"FBFB", LUT1_INITVAL=>X"0001")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_22, 
                B1=>I1_R_debounce_cnt_23, C1=>I1_R_debounce_cnt_17, 
                D1=>I1_R_debounce_cnt_11, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_8, B0=>I1_R_tx_phase_RNO_8_1, 
                C0=>I1_R_debounce_cnt_9, D0=>'X', M0=>'X', CE=>'X', CLK=>'X', 
                LSR=>'X', OFX1=>open, F1=>I1_R_tx_phase_RNO_8_1, Q1=>open, 
                OFX0=>open, F0=>I1_R_tx_phase_RNO_3_1, Q0=>open);
    I1_SLICE_67I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"0001")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_18, 
                B1=>I1_R_debounce_cnt_16, C1=>I1_R_debounce_cnt_19, 
                D1=>I1_R_debounce_cnt_1, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_18, B0=>I1_R_debounce_cnt_16, 
                C0=>I1_R_debounce_cnt_19, D0=>I1_R_debounce_cnt_1, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, 
                F1=>I1_R_debounce_cnt_RNIJVQA1_0_1, Q1=>open, OFX0=>open, 
                F0=>I1_g0_7, Q0=>open);
    I1_SLICE_68I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"0001")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_24, 
                B1=>I1_R_debounce_cnt_25, C1=>I1_R_debounce_cnt_3, 
                D1=>I1_R_debounce_cnt_2, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_24, B0=>I1_R_debounce_cnt_25, 
                C0=>I1_R_debounce_cnt_3, D0=>I1_R_debounce_cnt_2, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_g0_2_3, 
                Q1=>open, OFX0=>open, F0=>I1_g0_0_6_1, Q0=>open);
    I1_SLICE_69I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"0001")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_2, 
                B1=>I1_R_debounce_cnt_26, C1=>I1_R_debounce_cnt_31, 
                D1=>I1_R_debounce_cnt_3, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_2, B0=>I1_R_debounce_cnt_26, 
                C0=>I1_R_debounce_cnt_31, D0=>I1_R_debounce_cnt_3, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_g1_9_0, 
                Q1=>open, OFX0=>open, F0=>I1_g0_0_9_0_0, Q0=>open);
    I1_SLICE_70I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"0001")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_22, 
                B1=>I1_R_debounce_cnt_24, C1=>I1_R_debounce_cnt_21, 
                D1=>I1_R_debounce_cnt_23, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_22, B0=>I1_R_debounce_cnt_20, 
                C0=>I1_R_debounce_cnt_21, D0=>I1_R_debounce_cnt_23, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_g1_10_0, 
                Q1=>open, OFX0=>open, F0=>I1_g0_0_5, Q0=>open);
    I1_SLICE_71I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"0100")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_31, 
                B1=>I1_R_debounce_cnt_26, C1=>I1_R_debounce_cnt_17, 
                D1=>I1_R_debounce_cnt_0, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_10, B0=>I1_R_debounce_cnt_26, 
                C0=>I1_R_debounce_cnt_17, D0=>I1_R_debounce_cnt_31, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_g0_0_8_0, 
                Q1=>open, OFX0=>open, F0=>I1_g0_0_7_2, Q0=>open);
    I1_SLICE_72I: SLOGICB
      generic map (M0MUX=>"SIG", CLKMUX=>"SIG", CEMUX=>"VHI", GSR=>"DISABLED", 
                   SRMODE=>"ASYNC", LSRONMUX=>"OFF", LUT0_INITVAL=>X"FFFE", 
                   LUT1_INITVAL=>X"0001", CHECK_M0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_byte_old_4, 
                B1=>I1_R_byte_old_2, C1=>I1_R_byte_old_6, D1=>I1_R_byte_old_5, 
                DI1=>'X', DI0=>'X', A0=>I1_R_byte_old_2, 
                B0=>I1_R_byte_old_fast_4, C0=>I1_R_byte_old_6, 
                D0=>I1_R_byte_old_5, M0=>N_8, CE=>'X', CLK=>clk_25m_c, 
                LSR=>'X', OFX1=>open, F1=>I1_g0_0_1_1, Q1=>open, OFX0=>open, 
                F0=>I1_g0_3_2, Q0=>I1_R_byte_old_fast_4);
    I1_SLICE_73I: SLOGICB
      generic map (LUT0_INITVAL=>X"0011", LUT1_INITVAL=>X"50D8")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_g0_0_sn, B1=>I1_g2, 
                C1=>I1_R_tx_ser_0_sqmuxa, D1=>I1_g0_0_mb_1, DI1=>'X', DI0=>'X', 
                A0=>I1_R_byte_old_1, B0=>I1_R_byte_old_0, C0=>'X', 
                D0=>I1_R_byte_old_3, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>I1_R_tx_ser_1_sqmuxa_i, Q1=>open, OFX0=>open, 
                F0=>I1_R_tx_phase_RNO_7_0, Q0=>open);
    I1_SLICE_74I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"0001")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_7, 
                B1=>I1_R_debounce_cnt_6, C1=>I1_R_debounce_cnt_0, 
                D1=>I1_R_debounce_cnt_1, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_16, B0=>I1_R_debounce_cnt_18, 
                C0=>I1_R_debounce_cnt_1, D0=>I1_R_debounce_cnt_19, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_g0_3_5, 
                Q1=>open, OFX0=>open, F0=>I1_g0_0_7_1, Q0=>open);
    I1_SLICE_75I: SLOGICB
      generic map (LUT0_INITVAL=>X"1111", LUT1_INITVAL=>X"0001")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_17, 
                B1=>I1_R_debounce_cnt_8, C1=>I1_R_debounce_cnt_20, 
                D1=>I1_R_debounce_cnt_11, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_25, B0=>I1_R_debounce_cnt_24, C0=>'X', 
                D0=>'X', M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, 
                F1=>I1_R_debounce_cnt_RNICPRA1_17, Q1=>open, OFX0=>open, 
                F0=>I1_g0_0_0, Q0=>open);
    I1_SLICE_76I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"5500")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_un1_R_tx_phase_1, B1=>'X', 
                C1=>'X', D1=>I1_R_baudgen_16, DI1=>'X', DI0=>'X', 
                A0=>I1_R_tx_phase_1, B0=>I1_R_tx_phase_3, C0=>I1_R_tx_phase_2, 
                D0=>I1_R_tx_phase_0, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>I1_r_tx_tickcnt12, Q1=>open, OFX0=>open, 
                F0=>I1_g0_5_sx, Q0=>open);
    I1_SLICE_77I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"0100")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_25, 
                B1=>I1_R_debounce_cnt_5, C1=>I1_R_debounce_cnt_4, 
                D1=>I1_R_debounce_cnt_0, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_25, B0=>I1_R_debounce_cnt_24, 
                C0=>I1_R_debounce_cnt_20, D0=>I1_R_debounce_cnt_21, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_g1_11, 
                Q1=>open, OFX0=>open, F0=>I1_g0_0_8_1, Q0=>open);
    I1_SLICE_78I: SLOGICB
      generic map (LUT0_INITVAL=>X"FFFE", LUT1_INITVAL=>X"0055")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_10, B1=>'X', 
                C1=>'X', D1=>I1_R_debounce_cnt_7, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_7, B0=>I1_R_debounce_cnt_8, 
                C0=>I1_R_debounce_cnt_9, D0=>I1_R_debounce_cnt_6, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_g0_0_6_2, 
                Q1=>open, OFX0=>open, F0=>I1_g1_4, Q0=>open);
    I1_SLICE_79I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"0001")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>I1_R_debounce_cnt_7, 
                B1=>I1_R_debounce_cnt_6, C1=>I1_R_debounce_cnt_4, 
                D1=>I1_R_debounce_cnt_5, DI1=>'X', DI0=>'X', 
                A0=>I1_R_debounce_cnt_10, B0=>I1_R_debounce_cnt_8, 
                C0=>I1_R_debounce_cnt_11, D0=>I1_R_debounce_cnt_9, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, F1=>I1_g0_0_4, 
                Q1=>open, OFX0=>open, F0=>I1_g0_0_5_0, Q0=>open);
    I1_SLICE_80I: SLOGICB
      generic map (LUT0_INITVAL=>X"7F80")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>I1_R_tx_tickcnt_0, 
                B0=>I1_R_tx_tickcnt_2, C0=>I1_R_tx_tickcnt_1, 
                D0=>I1_R_tx_tickcnt_3, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>open, Q1=>open, OFX0=>open, 
                F0=>I1_R_tx_tickcnt_n3, Q0=>open);
    I1_SLICE_81I: SLOGICB
      generic map (LUT0_INITVAL=>X"6666")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>I1_R_tx_tickcnt_1, 
                B0=>I1_R_tx_tickcnt_0, C0=>'X', D0=>'X', M0=>'X', CE=>'X', 
                CLK=>'X', LSR=>'X', OFX1=>open, F1=>open, Q1=>open, OFX0=>open, 
                F0=>I1_R_tx_tickcnt_n1, Q0=>open);
    I1_SLICE_82I: SLOGICB
      generic map (LUT0_INITVAL=>X"0002")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>I1_R_debounce_cnt_0, 
                B0=>I1_R_debounce_cnt_8, C0=>I1_R_debounce_cnt_9, 
                D0=>I1_R_debounce_cnt_5, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>open, Q1=>open, OFX0=>open, F0=>I1_g0_1_6_1, 
                Q0=>open);
    I1_SLICE_83I: SLOGICB
      generic map (LUT0_INITVAL=>X"A000")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>I1_R_tx_tickcnt_fast_1, 
                B0=>'X', C0=>I1_R_tx_tickcnt_fast_0, 
                D0=>I1_R_tx_tickcnt_fast_2, M0=>'X', CE=>'X', CLK=>'X', 
                LSR=>'X', OFX1=>open, F1=>open, Q1=>open, OFX0=>open, 
                F0=>I1_un6_r_tx_tickcnt_x, Q0=>open);
    I1_SLICE_84I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>I1_R_debounce_cnt_14, 
                B0=>I1_R_debounce_cnt_12, C0=>I1_R_debounce_cnt_13, 
                D0=>I1_R_debounce_cnt_15, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>open, Q1=>open, OFX0=>open, 
                F0=>I1_R_debounce_cnt_RNIQLJM1_0_12, Q0=>open);
    ...
    SLICE_86I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>btn_down_c, B0=>btn_up_c, 
                C0=>'X', D0=>'X', M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>open, Q1=>open, OFX0=>open, F0=>N_32, Q0=>open);
    SLICE_87I: SLOGICB
    ...
    SLICE_88I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                ...
                D0=>btn_up_c, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, 
                F1=>open, Q1=>open, OFX0=>open, F0=>N_46, Q0=>open);
    SLICE_89I: SLOGICB
      generic map (LUT0_INITVAL=>X"CC00")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>btn_down_c, C0=>'X', 
                D0=>btn_left_c, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>open, Q1=>open, OFX0=>open, F0=>N_35, Q0=>open);
    SLICE_90I: SLOGICB
      generic map (LUT0_INITVAL=>X"EEEE")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>btn_left_c, B0=>btn_right_c, 
                C0=>'X', D0=>'X', M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>open, Q1=>open, OFX0=>open, F0=>N_47, Q0=>open);
    led_7_I: led_7_B
    ...
    rs232_tx_MGIOLI: rs232_tx_MGIOL
      port map (IOLDO=>rs232_tx_c, ONEG0=>I1_R_tx_ser_5_0, 
                CE=>I1_R_tx_ser_1_sqmuxa_i, CLK=>clk_25m_c);
    clk_25mI: clk_25mB
    ...
    led_3_I: led_3_B
      port map (PADDO=>N_41, led3=>led(3));
    led_1_I: led_1_B
      port map (PADDO=>N_43, led1=>led(1));
    led_2_I: led_2_B
      port map (PADDO=>N_42, led2=>led(2));
    led_0_I: led_0_B
      port map (PADDO=>N_45, led0=>led(0));
    led_4_I: led_4_B
      port map (PADDO=>N_8, led4=>led(4));
    led_6_I: led_6_B
      port map (PADDO=>N_11, led6=>led(6));
    led_5_I: led_5_B
      port map (PADDO=>N_12, led5=>led(5));
    VHI_INST: VHI
      port map (Z=>VCCI);
    PUR_INST: PUR
      port map (PUR=>VCCI);
