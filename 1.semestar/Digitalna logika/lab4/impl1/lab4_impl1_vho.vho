...
-- ldbanno -n VHDL -o lab4_impl1_vho.vho -w -neg -gui lab4_impl1.ncd 
-- Netlist created on Thu Dec 10 21:16:49 2020
-- Netlist written on Thu Dec 10 21:17:07 2020
...
-- entity count
  ...
  entity count is
    port (clk_25m: in Std_logic; btn_down: in Std_logic; 
  ...
  architecture Structure of count is
    ...
    signal r_cry_0: Std_logic;
    signal R_31: Std_logic;
    signal r_31_S: Std_logic;
    signal clk_25m_c: Std_logic;
    signal r_cry_30: Std_logic;
    signal R_30: Std_logic;
    signal R_29: Std_logic;
    signal r_30_S: Std_logic;
    signal r_29_S: Std_logic;
    signal r_cry_28: Std_logic;
    signal R_28: Std_logic;
    signal R_27: Std_logic;
    signal r_28_S: Std_logic;
    signal r_27_S: Std_logic;
    signal r_cry_26: Std_logic;
    signal R_26: Std_logic;
    signal R_25: Std_logic;
    signal r_26_S: Std_logic;
    signal r_25_S: Std_logic;
    signal r_cry_24: Std_logic;
    signal R_24: Std_logic;
    signal R_23: Std_logic;
    signal r_24_S: Std_logic;
    signal r_23_S: Std_logic;
    signal r_cry_22: Std_logic;
    signal R_22: Std_logic;
    signal R_21: Std_logic;
    signal r_22_S: Std_logic;
    signal r_21_S: Std_logic;
    signal r_cry_20: Std_logic;
    signal R_20: Std_logic;
    signal R_19: Std_logic;
    signal r_20_S: Std_logic;
    signal r_19_S: Std_logic;
    signal r_cry_18: Std_logic;
    signal R_18: Std_logic;
    signal R_17: Std_logic;
    signal r_18_S: Std_logic;
    signal r_17_S: Std_logic;
    signal r_cry_16: Std_logic;
    signal R_16: Std_logic;
    signal R_15: Std_logic;
    signal r_16_S: Std_logic;
    signal r_15_S: Std_logic;
    signal r_cry_14: Std_logic;
    signal R_14: Std_logic;
    signal R_13: Std_logic;
    signal r_14_S: Std_logic;
    signal r_13_S: Std_logic;
    signal r_cry_12: Std_logic;
    signal R_12: Std_logic;
    signal R_11: Std_logic;
    signal r_12_S: Std_logic;
    signal r_11_S: Std_logic;
    signal r_cry_10: Std_logic;
    signal R_10: Std_logic;
    signal R_9: Std_logic;
    signal r_10_S: Std_logic;
    signal r_9_S: Std_logic;
    signal r_cry_8: Std_logic;
    signal R_8: Std_logic;
    signal R_7: Std_logic;
    signal r_8_S: Std_logic;
    signal r_7_S: Std_logic;
    signal r_cry_6: Std_logic;
    signal R_6: Std_logic;
    signal R_5: Std_logic;
    signal r_6_S: Std_logic;
    signal r_5_S: Std_logic;
    signal r_cry_4: Std_logic;
    signal R_4: Std_logic;
    signal sw_c_3: Std_logic;
    signal R_3: Std_logic;
    signal r_4_S: Std_logic;
    signal r_3_S: Std_logic;
    signal r_cry_2: Std_logic;
    signal R_2: Std_logic;
    signal sw_c_2: Std_logic;
    signal R_1: Std_logic;
    signal sw_c_1: Std_logic;
    signal r_2_S: Std_logic;
    signal r_1_S: Std_logic;
  ...
  begin
    SLICE_0I: SCCU2B
      generic map (CCU2_INJECT1_0=>"NO", CCU2_INJECT1_1=>"NO", 
                   INIT0_INITVAL=>"0x0000", INIT1_INITVAL=>"0x66CC")
      port map (M1=>'X', A1=>sw_c_0, B1=>r, C1=>'X', D1=>VCC, DI1=>'X', 
                DI0=>'X', A0=>'X', B0=>'X', C0=>'X', D0=>'X', FCI=>'X', 
                M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', FCO=>r_cry_0, F1=>open, 
    ...
    SLICE_1I: SCCU2B
      ...
      port map (M1=>'X', A1=>'X', B1=>'X', C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>r_31_S, A0=>'X', B0=>R_31, C0=>'X', D0=>VCC, 
                FCI=>r_cry_30, M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', 
                FCO=>open, F1=>open, Q1=>open, F0=>r_31_S, Q0=>R_31);
    SLICE_2I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0xCC00", 
      ...
      port map (M1=>'X', A1=>'X', B1=>R_30, C1=>'X', D1=>VCC, DI1=>r_30_S, 
                DI0=>r_29_S, A0=>'X', B0=>R_29, C0=>'X', D0=>VCC, 
                FCI=>r_cry_28, M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', 
                FCO=>r_cry_30, F1=>r_30_S, Q1=>R_30, F0=>r_29_S, Q0=>R_29);
    SLICE_3I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   ...
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>R_28, C1=>'X', D1=>VCC, DI1=>r_28_S, 
                DI0=>r_27_S, A0=>R_27, B0=>'X', C0=>'X', D0=>VCC, 
                FCI=>r_cry_26, M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', 
                FCO=>r_cry_28, F1=>r_28_S, Q1=>R_28, F0=>r_27_S, Q0=>R_27);
    SLICE_4I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0xCC00", 
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>R_26, C1=>'X', D1=>VCC, DI1=>r_26_S, 
                DI0=>r_25_S, A0=>'X', B0=>R_25, C0=>'X', D0=>VCC, 
                FCI=>r_cry_24, M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', 
                FCO=>r_cry_26, F1=>r_26_S, Q1=>R_26, F0=>r_25_S, Q0=>R_25);
    SLICE_5I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0xCC00", 
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>R_24, C1=>'X', D1=>VCC, DI1=>r_24_S, 
                DI0=>r_23_S, A0=>'X', B0=>R_23, C0=>'X', D0=>VCC, 
                FCI=>r_cry_22, M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', 
                FCO=>r_cry_24, F1=>r_24_S, Q1=>R_24, F0=>r_23_S, Q0=>R_23);
    SLICE_6I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0xAA00", 
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>R_22, C1=>'X', D1=>VCC, DI1=>r_22_S, 
                DI0=>r_21_S, A0=>R_21, B0=>'X', C0=>'X', D0=>VCC, 
                FCI=>r_cry_20, M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', 
                FCO=>r_cry_22, F1=>r_22_S, Q1=>R_22, F0=>r_21_S, Q0=>R_21);
    SLICE_7I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0xCC00", 
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>R_20, C1=>'X', D1=>VCC, DI1=>r_20_S, 
                DI0=>r_19_S, A0=>'X', B0=>R_19, C0=>'X', D0=>VCC, 
                FCI=>r_cry_18, M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', 
                FCO=>r_cry_20, F1=>r_20_S, Q1=>R_20, F0=>r_19_S, Q0=>R_19);
    SLICE_8I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0xCC00", 
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>R_18, C1=>'X', D1=>VCC, DI1=>r_18_S, 
                DI0=>r_17_S, A0=>'X', B0=>R_17, C0=>'X', D0=>VCC, 
                FCI=>r_cry_16, M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', 
                FCO=>r_cry_18, F1=>r_18_S, Q1=>R_18, F0=>r_17_S, Q0=>R_17);
    SLICE_9I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0xAA00", 
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>R_16, C1=>'X', D1=>VCC, DI1=>r_16_S, 
                DI0=>r_15_S, A0=>R_15, B0=>'X', C0=>'X', D0=>VCC, 
                FCI=>r_cry_14, M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', 
                FCO=>r_cry_16, F1=>r_16_S, Q1=>R_16, F0=>r_15_S, Q0=>R_15);
    SLICE_10I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0xCC00", 
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>R_14, C1=>'X', D1=>VCC, DI1=>r_14_S, 
                DI0=>r_13_S, A0=>'X', B0=>R_13, C0=>'X', D0=>VCC, 
                FCI=>r_cry_12, M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', 
                FCO=>r_cry_14, F1=>r_14_S, Q1=>R_14, F0=>r_13_S, Q0=>R_13);
    SLICE_11I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0xCC00", 
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>R_12, C1=>'X', D1=>VCC, DI1=>r_12_S, 
                DI0=>r_11_S, A0=>'X', B0=>R_11, C0=>'X', D0=>VCC, 
                FCI=>r_cry_10, M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', 
                FCO=>r_cry_12, F1=>r_12_S, Q1=>R_12, F0=>r_11_S, Q0=>R_11);
    SLICE_12I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0xAA00", 
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>R_10, C1=>'X', D1=>VCC, DI1=>r_10_S, 
                DI0=>r_9_S, A0=>R_9, B0=>'X', C0=>'X', D0=>VCC, FCI=>r_cry_8, 
                M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', FCO=>r_cry_10, 
                F1=>r_10_S, Q1=>R_10, F0=>r_9_S, Q0=>R_9);
    SLICE_13I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0xCC00", 
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>R_8, C1=>'X', D1=>VCC, DI1=>r_8_S, 
                DI0=>r_7_S, A0=>'X', B0=>R_7, C0=>'X', D0=>VCC, FCI=>r_cry_6, 
                M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', FCO=>r_cry_8, 
                F1=>r_8_S, Q1=>R_8, F0=>r_7_S, Q0=>R_7);
    SLICE_14I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0xCC00", 
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>R_6, C1=>'X', D1=>VCC, DI1=>r_6_S, 
                DI0=>r_5_S, A0=>'X', B0=>R_5, C0=>'X', D0=>VCC, FCI=>r_cry_4, 
                M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', FCO=>r_cry_6, 
                F1=>r_6_S, Q1=>R_6, F0=>r_5_S, Q0=>R_5);
    SLICE_15I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0x66AA", 
                   INIT1_INITVAL=>"0xCC00", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>R_4, C1=>'X', D1=>VCC, DI1=>r_4_S, 
                DI0=>r_3_S, A0=>R_3, B0=>sw_c_3, C0=>'X', D0=>VCC, 
                FCI=>r_cry_2, M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', 
                FCO=>r_cry_4, F1=>r_4_S, Q1=>R_4, F0=>r_3_S, Q0=>R_3);
    SLICE_16I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", INIT0_INITVAL=>"0x66CC", 
                   INIT1_INITVAL=>"0x66CC", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>sw_c_2, B1=>R_2, C1=>'X', D1=>VCC, DI1=>r_2_S, 
                DI0=>r_1_S, A0=>sw_c_1, B0=>R_1, C0=>'X', D0=>VCC, 
                FCI=>r_cry_0, M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', 
                FCO=>r_cry_2, F1=>r_2_S, Q1=>R_2, F0=>r_1_S, Q0=>R_1);
    SLICE_17I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>r_0, A0=>sw_c_0, B0=>'X', C0=>'X', 
                D0=>r, M0=>'X', CE=>'X', CLK=>clk_25m_c, LSR=>'X', OFX1=>open, 
                F1=>open, Q1=>open, OFX0=>open, F0=>r_0, Q0=>r);
    SLICE_18I: SLOGICB
      generic map (LUT0_INITVAL=>X"CACA")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>R_24, B0=>R_16, 
    ...
    SLICE_19I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>R_25, B0=>btn_down_c, C0=>'X', 
                D0=>R_17, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, 
                F1=>open, Q1=>open, OFX0=>open, F0=>led_c_1, Q0=>open);
    SLICE_20I: SLOGICB
      generic map (LUT0_INITVAL=>X"CFC0")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>R_18, C0=>btn_down_c, 
                D0=>R_26, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, 
                F1=>open, Q1=>open, OFX0=>open, F0=>led_c_2, Q0=>open);
    SLICE_21I: SLOGICB
      generic map (LUT0_INITVAL=>X"E2E2")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>R_27, B0=>btn_down_c, 
                C0=>R_19, D0=>'X', M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>open, Q1=>open, OFX0=>open, F0=>led_c_3, 
                Q0=>open);
    SLICE_22I: SLOGICB
      generic map (LUT0_INITVAL=>X"AFA0")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>R_20, B0=>'X', C0=>btn_down_c, 
                D0=>R_28, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, 
                F1=>open, Q1=>open, OFX0=>open, F0=>led_c_4, Q0=>open);
    SLICE_23I: SLOGICB
      generic map (LUT0_INITVAL=>X"F5A0")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>btn_down_c, B0=>'X', C0=>R_21, 
                D0=>R_29, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, 
                F1=>open, Q1=>open, OFX0=>open, F0=>led_c_5, Q0=>open);
    SLICE_24I: SLOGICB
      generic map (LUT0_INITVAL=>X"CACA")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>R_30, B0=>R_22, 
                C0=>btn_down_c, D0=>'X', M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
    ...
    SLICE_25I: SLOGICB
      generic map (LUT0_INITVAL=>X"AFA0")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>R_23, B0=>'X', C0=>btn_down_c, 
                D0=>R_31, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, 
