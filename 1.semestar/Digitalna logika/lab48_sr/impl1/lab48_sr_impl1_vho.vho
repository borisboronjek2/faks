...
-- ldbanno -n VHDL -o lab48_sr_impl1_vho.vho -w -neg -gui lab48_sr_impl1.ncd 
-- Netlist created on Thu Dec 10 21:22:47 2020
-- Netlist written on Thu Dec 10 21:23:06 2020
...
-- entity count
  ...
  architecture Structure of count is
    ...
    signal un2_r_s_7_0_S0: Std_logic;
    signal btn_right_c: Std_logic;
    signal clk_key: Std_logic;
    signal un2_r_cry_6: Std_logic;
    signal led_c_6: Std_logic;
    signal led_c_5: Std_logic;
    signal un2_r_cry_5_0_S1: Std_logic;
    signal un2_r_cry_5_0_S0: Std_logic;
    signal un2_r_cry_4: Std_logic;
    signal led_c_4: Std_logic;
    signal led_c_3: Std_logic;
    signal un2_r_cry_3_0_S1: Std_logic;
    signal un2_r_cry_3_0_S0: Std_logic;
    signal un2_r_cry_2: Std_logic;
    signal led_c_2: Std_logic;
    signal led_c_1: Std_logic;
    signal un2_r_cry_1_0_S1: Std_logic;
    signal un2_r_cry_1_0_S0: Std_logic;
  ...
  begin
    SLICE_0I: SCCU2B
      ...
      port map (M1=>'X', A1=>led_c_0, B1=>'X', C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>'X', A0=>'X', B0=>'X', C0=>'X', D0=>VCC, FCI=>'X', 
                M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', FCO=>un2_r_cry_0, 
    ...
    I_debouncer_SLICE_6I: SCCU2B
      ...
      port map (M1=>'X', A1=>'X', B1=>I_debouncer_R_debounce_cnt_22, C1=>'X', 
                ...
                DI0=>I_debouncer_un1_r_debounce_cnt_11, A0=>'X', 
                B0=>I_debouncer_R_debounce_cnt_21, C0=>'X', 
                D0=>I_debouncer_VCC, 
    ...
    I_debouncer_SLICE_9I: SCCU2B
      ...
      port map (M1=>'X', A1=>'X', B1=>I_debouncer_R_debounce_cnt_16, C1=>'X', 
                ...
                DI0=>I_debouncer_un1_r_debounce_cnt_17, A0=>'X', 
                B0=>I_debouncer_R_debounce_cnt_15, C0=>'X', 
                D0=>I_debouncer_VCC, 
    ...
    I_debouncer_SLICE_17I: SCCU2B
      ...
      port map (M1=>'X', A1=>I_debouncer_R_debounce_cnt_0, B1=>'X', C1=>'X', 
    ...
    SLICE_18I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", LSRMUX=>"SIG", 
                   ...
                   REG0_SD=>"VHI", CHECK_DI0=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>'X', C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>un2_r_s_7_0_S0, A0=>'X', B0=>led_c_7, C0=>'X', D0=>VCC, 
                FCI=>un2_r_cry_6, M0=>'X', CE=>'X', CLK=>clk_key, 
                LSR=>btn_right_c, FCO=>open, F1=>open, Q1=>open, 
                F0=>un2_r_s_7_0_S0, Q0=>led_c_7);
    SLICE_19I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", LSRMUX=>"SIG", 
                   CCU2_INJECT1_0=>"NO", CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>led_c_6, C1=>'X', D1=>VCC, 
                DI1=>un2_r_cry_5_0_S1, DI0=>un2_r_cry_5_0_S0, A0=>'X', 
                B0=>led_c_5, C0=>'X', D0=>VCC, FCI=>un2_r_cry_4, M0=>'X', 
                CE=>'X', CLK=>clk_key, LSR=>btn_right_c, FCO=>un2_r_cry_6, 
                F1=>un2_r_cry_5_0_S1, Q1=>led_c_6, F0=>un2_r_cry_5_0_S0, 
                Q0=>led_c_5);
    SLICE_20I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", LSRMUX=>"SIG", 
                   CCU2_INJECT1_0=>"NO", CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", 
      ...
      port map (M1=>'X', A1=>'X', B1=>led_c_4, C1=>'X', D1=>VCC, 
                DI1=>un2_r_cry_3_0_S1, DI0=>un2_r_cry_3_0_S0, A0=>led_c_3, 
                B0=>'X', C0=>'X', D0=>VCC, FCI=>un2_r_cry_2, M0=>'X', CE=>'X', 
                CLK=>clk_key, LSR=>btn_right_c, FCO=>un2_r_cry_4, 
                F1=>un2_r_cry_3_0_S1, Q1=>led_c_4, F0=>un2_r_cry_3_0_S0, 
                Q0=>led_c_3);
    SLICE_21I: SCCU2B
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", LSRMUX=>"SIG", 
                   CCU2_INJECT1_0=>"NO", CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", 
      ...
      port map (M1=>'X', A1=>'X', B1=>led_c_2, C1=>'X', D1=>VCC, 
                DI1=>un2_r_cry_1_0_S1, DI0=>un2_r_cry_1_0_S0, A0=>'X', 
                B0=>led_c_1, C0=>'X', D0=>VCC, FCI=>un2_r_cry_0, M0=>'X', 
                CE=>'X', CLK=>clk_key, LSR=>btn_right_c, FCO=>un2_r_cry_2, 
                F1=>un2_r_cry_1_0_S1, Q1=>led_c_2, F0=>un2_r_cry_1_0_S0, 
                Q0=>led_c_1);
    ...
    SLICE_24I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", LSRMUX=>"SIG", GSR=>"DISABLED", 
                   ...
                   CHECK_LSR=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>led_c_i_0, A0=>'X', B0=>'X', C0=>'X', 
                D0=>led_c_0, M0=>'X', CE=>'X', CLK=>clk_key, LSR=>btn_right_c, 
                OFX1=>open, F1=>open, Q1=>open, OFX0=>open, F0=>led_c_i_0, 
                Q0=>led_c_0);
    I_debouncer_SLICE_25I: SLOGICB
      generic map (LUT0_INITVAL=>X"A5A5")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>I_debouncer_R_key_sync, 
                B0=>'X', C0=>clk_key, D0=>'X', M0=>'X', CE=>'X', CLK=>'X', 
                LSR=>'X', OFX1=>open, F1=>open, Q1=>open, OFX0=>open, 
                F0=>I_debouncer_r_debounce_cnt12_i, Q0=>open);
    I_debouncer_SLICE_26I: SLOGICB
      generic map (M0MUX=>"SIG", CLKMUX=>"SIG", CEMUX=>"SIG", GSR=>"DISABLED", 
                   SRMODE=>"ASYNC", LSRONMUX=>"OFF", LUT0_INITVAL=>X"0CC0", 
                   CHECK_M0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', 
                B0=>I_debouncer_R_debounce_cnt_31, C0=>I_debouncer_R_key_sync, 
                D0=>clk_key, M0=>I_debouncer_R_key_sync, 
                CE=>I_debouncer_R_key_last_0_sqmuxa, CLK=>clk_25m_c, LSR=>'X', 
                OFX1=>open, F1=>open, Q1=>open, OFX0=>open, 
                F0=>I_debouncer_R_key_last_0_sqmuxa, Q0=>clk_key);
